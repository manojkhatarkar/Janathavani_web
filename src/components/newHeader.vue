        ...
        <nav id="sc-primary-nav" aria-label="Header Navigation" class="nav-scroll-js m-h-60 z-7 header-nav hide-for-print items-center justify-center w-100 border-box fixed blck-font bg-white" data-sc-v="5.1.1" data-sc-c="basenav">
            <div :class="isMobile?'row nav-header-pd mobile-ro':'row nav-header-pd'">
                <div :class="isMobile?'col-2 un-p txt-center':'col-1 un-p txt-center'">
                    <img src="../assets/images/icon/search.png" class="pt-20" @click="isShowing ^= true">
                    <router-link to="/" >
                        <img src="../assets/images/icon/home-line.png" class="pd-l-10 pt-20">
                    </router-link>
                </div>
                ...
                <div :class="isMobile?'col-8':'col-10'">
                    <template v-if="isMobile==false">
                        ...
                        <div class="logo-dis" style="display:none;">
                            <router-link to="/" >
                                <img src="../assets/assembler/images/logo.webp" class="logo-new pt-10" >
                            </router-link>
                        </div>
                    </template>
                    <template v-else>
                        <div class="logo-dis-mobile" >
                            <router-link to="/" >
                                <img src="../assets/assembler/images/logo.webp" class="logo-new-mobile pt-10" >
                            </router-link>    
                        </div>
                    </template>
                </div>
                <div :class="isMobile?'col-2 un-p txt-center':'col-1 un-p txt-center'">
                    <router-link to="/Ebook" >
                        <img src="../assets/images/icon/magnifier.png"  class="pt-20">
                    </router-link>
                    
                    <img src="../assets/images/icon/user-line.png" class="pd-l-10 pt-20" @click="checkDrop()" >
                </div>
            ...
            <div class="card drop-box" v-if="rightMenu" >
                <div class="card-content">
                    <ul>
                        <li><router-link to="{ name: 'SignIn' }" class="dib-ns sign-in-text truncate mr-xxs mw-144 font-times" data-sc-v="5.1.1" data-sc-c="navbutton">Sign in</router-link></li>
