<template>
<div>
    <nav id="sc-primary-nav" aria-label="Header Navigation" class=" z-7 header-nav flex hide-for-print items-center justify-center w-100 border-box fixed blck-font bg-white" data-sc-v="5.1.1" data-sc-c="basenav">
        <div data-sc-v="5.1.1" data-sc-c="keyboardonlynavlinks">
            <a data-href="#accessibility/index.html" class="
            skip-link
          ...
          " data-sc-v="5.1.1" data-sc-c="keyboardonlynavlinks">Accessibility statement</a><a data-href="##main-content" class="
            skip-link
            sr-only sr-only-focusable
            white
            underline
        ...
        <div class="flex flex-1 ml-xs ml-sm-ns" style="line-height: 60px; height: 60px" data-sc-v="5.1.1" data-sc-c="basenav">
            <!-- <div id="search-form"   class="search-form dn flex-ns items-center relative"  role="search">
                ...
                <label for="query " aria-labelledby="searchTitle">
                    <input type="text" id="query" v-model="searchText" autocomplete="off" name="query" :class="searchShowing ? 'search-bar-show' : 'b-none dn hidden'" class="no-shadow text-input brad-4 font-xxxs pa-0 " placeholder="Search" aria-label="search" value=""></label>
            ...
            changethis " >
                    <div class="flex-ns" data-sc-v="5.1.1" data-sc-c="navbutton">
                        ...
                        <img src="../assets/images/icon/home.png" class="hide-mobile" @click="$router.push('/')" >
                    </div>
                </button>
            </div>
            ...
            <!-- <div class="">
                <img src="../assets/images/icon/home.png" class="home-lg-icon" style="margin-left: 10px;" >
            </div> -->
        ...
        " style="flex: 10; height: 60px; line-height: 60px" data-qa="header-nav-links-ul">
            <li class="mr-md db cat-dropdown" v-for="category in allCategory" :key="category.id">
                ...
                <router-link :to="{
                      ...
                      }" class="gray-lightest-bk blck-font hover-white pointer"> {{category.heading}} </router-link>
...
<router-link :to="{
                        name: 'contactus',
                      }" class="gray-lightest-bk blck-font hover-white pointer" > ಸಂಪರ್ಕಿಸಿ </router-link>
            </li>
        ...
        "><a data-href="##" class="flex flex-column items-center center"><span class="
            ...
            <img width="100" src="../assets/assembler/images/logo.webp" />
            </router-link><br />
            </span></a></span>
        <div class="flex flex-1 justify-end mr-xs mr-sm-ns" data-sc-v="5.1.1" data-sc-c="basenav">
            <div class="ml-xs mw-200  db-ns" data-sc-v="5.1.1" data-sc-c="rendernavbutton">
                <router-link v-if="!uid" :to="{ name: 'SignIn' }" data-qa="sc-account-button-not-small" class="
              transition-color
              duration-400
              ease-in-out
              f-c-w btn
              focus-highlight pt-8 changethis
            ">
                    <div class="flex-ns" data-sc-v="5.1.1" data-sc-c="navbutton">
...
export default {
    ...
    mounted() {
        ...
        $('#homeLogo').fadeOut(500, function() {
                        ...
                        $(".home-lg-icon").attr('style','width:40% !important;margin-left:15px;')
        ...
        $(window).scroll(function () {
            if ($(this).scrollTop() > 100) {
                $('#homeNav').fadeOut(500, function() {
                        ...
                        $(".home-lg-icon").attr('style','width:30% !important;margin-left:15px;')
